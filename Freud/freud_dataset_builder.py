"""
Freud Mental Health AI - Dataset Builder
=========================================

This script takes your existing Dataset.json and enhances it for better training:
- Adds response variations to prevent repetition
- Creates better multi-turn conversations
- Balances the dataset across emotions
- Adds proper formatting for the model
...
class FreudDatasetBuilder:
    ...
    def create_multi_turn_sample(self, emotion: str, turns: List[Tuple[str, str]]) -> str:
        ...
        Args:
            emotion: The emotion tag for this conversation
...
def main():
    ...
    print("\n📝 Next Steps:")
    print("   1. Review the samples above to verify quality")
    print("   2. Upload 'freud_training_data/' folder to Kaggle")
